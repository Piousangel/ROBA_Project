...
def run_server():
    ...
    # ----------------------------------------------------------------------- #
    store = ModbusSlaveContext(
        di=ModbusSequentialDataBlock(0, [17]*10000),
        co=ModbusSequentialDataBlock(0, [17]*10000),
        hr=ModbusSequentialDataBlock(0, [17]*10000),
        ir=ModbusSequentialDataBlock(0, [17]*10000))
    ...
    # ----------------------------------------------------------------------- #
    # Tcp:
    StartTcpServer(context, identity=identity, address=("127.0.0.1", 500))
    #
